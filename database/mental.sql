...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2026 at 06:48 PM
...
(15, 8, 4, '2026-01-16', '12:09:00', 'completed');
...
(5, 4, '2026-01-16', '12:09:00', '14:13:00');
...
(18, 15, 4, 'sghfhgf1234', '2026-01-05 15:10:39');
...
--
ALTER TABLE `future_letters`
  MODIFY `letter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `daily_mood`
  ADD CONSTRAINT `fk_daily_mood_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
