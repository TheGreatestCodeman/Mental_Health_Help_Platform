...
INSERT INTO `events` (`event_id`, `participants`, `date`, `name`, `user_id`) VALUES
(0, 6, '2026-03-06', 'Atif Aslam Concwet', 9);
...
INSERT INTO `post` (`post_id`, `group_id`, `sharable_link`, `post_from_past`, `comments`) VALUES
(1, NULL, NULL, 'i hate myself', NULL),
(11, NULL, NULL, 'damn son', NULL),
(12, NULL, NULL, 'ollopp', NULL),
(13, 4, NULL, 'The world', NULL);
...
INSERT INTO `user_group` (`group_id`, `user_id`, `members`, `name`) VALUES
(1, 9, NULL, 'lol'),
(4, NULL, 1, 'iwozx');
...
ALTER TABLE `post`
  ...
  ADD KEY `group_id` (`group_id`),
  ADD KEY `idx_post_group_id` (`group_id`);
...
--
ALTER TABLE `message_content`
  ADD CONSTRAINT `message_content_ibfk_1` FOREIGN KEY (`message_id`) REFERENCES `dm` (`message_id`) ON DELETE CASCADE;

--
-- Constraints for table `post`
--
ALTER TABLE `post`
  ADD CONSTRAINT `post_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `user_group` (`group_id`) ON DELETE SET NULL;
